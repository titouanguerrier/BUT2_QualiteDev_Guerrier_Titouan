        ...
        for base in cls.__orig_bases__:
            if (isinstance(base, typing._GenericAlias)
                ...
                if gvars is not None:
                    raise TypeError("Cannot inherit from Generic[...]"
    ...
    class _ProtocolMeta(_ProtocolMetaBase):
        ...
        def __new__(mcls, name, bases, namespace, **kwargs):
            if name == "Protocol" and len(bases) < 2:
                ...
                for base in bases:
                    if not (base in {
                            object, typing.Generic, Protocol, _typing_Protocol
        ...
        def __eq__(cls, other):
            ...
            if abc.ABCMeta.__eq__(cls, other) is True:
                return True
            return (cls is Protocol
                    and other is getattr(typing, "Protocol", object()))
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(typing.Generic, metaclass=_ProtocolMeta):
            ...
            def __init_subclass__(cls, *args, **kwargs):
                ...
                if not cls.__dict__.get('_is_protocol', False):
                    cls._is_protocol = any(b is Protocol
...
if sys.version_info >= (3, 13):
    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, total=True):
            ...
            tp_dict = type.__new__(_TypedDictMeta, _fake_name,
...
if hasattr(typing, "is_protocol"):
    ...
    def is_protocol(__tp: type) -> bool:
        ...
        Example::
            ...
            False
        """
        return (isinstance(__tp, type) and getattr(__tp, '_is_protocol', False)
