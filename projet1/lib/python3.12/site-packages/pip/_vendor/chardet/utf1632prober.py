...
class UTF1632Prober(CharSetProber):
    ...
    def is_likely_utf16be(self) -> bool:
        ...
        return approx_chars >= self.MIN_CHARS_FOR_DETECTION and (
            ...
            > self.EXPECTED_RATIO and
            (self.zeros_at_mod[0] + self.zeros_at_mod[2]) / approx_chars
            > self.EXPECTED_RATIO and not self.invalid_utf16be)
    ...
    def is_likely_utf16le(self) -> bool:
        ...
        return approx_chars >= self.MIN_CHARS_FOR_DETECTION and (
            ...
            > self.EXPECTED_RATIO and
            (self.zeros_at_mod[1] + self.zeros_at_mod[3]) / approx_chars
            > self.EXPECTED_RATIO and not self.invalid_utf16le)
    ...
    def get_confidence(self) -> float:
        return (0.85 if (self.is_likely_utf16le() or self.is_likely_utf16be()
                         or self.is_likely_utf32le()
                         or self.is_likely_utf32be()) else 0.00)
