...
class Factory:
    ...
    def __init__(
        ...
        self._installed_candidate_cache: Dict[str,
                                              AlreadyInstalledCandidate] = {}
        self._extras_candidate_cache: Dict[Tuple[int,
    ...
    def _make_requirements_from_install_req(
            ...
            requested_extras: Iterable[str]) -> Iterator[Requirement]:
        """
    ...
    def get_installation_error(
        ...
        msg = (f"Cannot install {info} because these package versions "
