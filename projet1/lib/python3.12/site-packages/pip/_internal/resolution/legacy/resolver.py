...
class Resolver(BaseResolver):
    ...
    def _add_requirement_to_set(
        ...
        assert (not install_req.user_supplied or parent_req_name
                is None), "a user supplied req shouldn't have a parent"
    ...
    def _resolve_one(
        ...
        with indent_log():
            ...
            if not requirement_set.has_requirement(req_to_install.name):
                ...
                self._add_requirement_to_set(requirement_set,
                                             req_to_install,
