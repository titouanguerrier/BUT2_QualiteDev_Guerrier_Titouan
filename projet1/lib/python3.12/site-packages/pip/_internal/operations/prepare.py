...
class RequirementPreparer:
    ...
    def _fetch_metadata_only(
        ...
        return self._fetch_metadata_using_link_data_attr(
            req) or self._fetch_metadata_using_lazy_wheel(req.link)
    ...
    def _fetch_metadata_using_link_data_attr(
        ...
        if canonicalize_name(metadata_dist.raw_name) != canonicalize_name(
                req.req.name):
            raise MetadataInconsistent(req, "Name", req.req.name,
    ...
    def _prepare_linked_requirement(self, req: InstallRequirement,
        ...
        if req.download_info is None:
            ...
            if (isinstance(req.download_info.info, ArchiveInfo)
                    and not req.download_info.info.hashes and local_file):
