    ...
    def match_markers(self,
        ...
        if self.markers is not None:
            return any(
                ...
                or self.markers.evaluate({"extra": safe_extra(extra)}) or
                self.markers.evaluate({"extra": canonicalize_name(extra)})
    ...
    def install(
        ...
        if self.editable and not self.is_wheel:
            ...
            install_editable_legacy(
                ...
                if global_options is not None else [],
                prefix=prefix,
                home=home,
...
def _has_option(options: Values, reqs: List[InstallRequirement],
                option: str) -> bool:
